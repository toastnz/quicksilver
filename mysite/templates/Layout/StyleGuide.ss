<div id="style">
    ...
    <div class="header">
        <h2 class="style__header">STYLEGUIDE</h2>
    </div>
    ...
    <section class="forms">
        ...
        <div class="input-wrap__text input-wrap__half">
            <label>Text Input</label>
            <input type="text" placeholder="Text Input">
        </div>

        <div class="input-wrap__email input-wrap__half input-wrap__half--last">
            <label>Text Input</label>
            <input type="email" placeholder="Email Input">
        </div>

        <div class="input-wrap__textarea">
            <label>Text Input</label>
            <textarea placeholder="Textarea"></textarea>
        </div>

        <div class="input-wrap__select">
            <label>Selct Input</label>
            <select>
