<div class="styleguide innerWrap wysiwyg">

    <h1 class="subtitle"><span>STYLEGUIDE</span></h1>

    <a class="button" href="#typography">Typography</a>
    <a class="button" href="#buttons">Buttons</a>
    <a class="button" href="#lists">Lists</a>
    <a class="button" href="#blockquote">Blockquote</a>
