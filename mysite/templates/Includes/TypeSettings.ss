...
<div id="typeSettings" class="type-settings">
    ...
    <div class="scroll-wrap">
        ...
        <div class="headingWrap">
            <div class="innerWrap">
                <h6 class="js-collapsible" data-colapsible-target="#Heading_1">HEADING 1 <i class="fa fa-angle-down" aria-hidden="true"></i></h6>
        ...
        <div class="headingWrap">
            <div class="innerWrap">
                <h6 class="js-collapsible" data-colapsible-target="#Heading_2">HEADING 2 <i class="fa fa-angle-down" aria-hidden="true"></i></h6>
        ...
        <div class="headingWrap">
            <div class="innerWrap">
                <h6 class="js-collapsible" data-colapsible-target="#Heading_3">HEADING 3 <i class="fa fa-angle-down" aria-hidden="true"></i></h6>
        ...
        <div class="headingWrap">
            <div class="innerWrap">
                <h6 class="js-collapsible" data-colapsible-target="#Heading_4">HEADING 4 <i class="fa fa-angle-down" aria-hidden="true"></i></h6>
        ...
        <div class="headingWrap">
            <div class="innerWrap">
                <h6 class="js-collapsible" data-colapsible-target="#Heading_5">HEADING 5 <i class="fa fa-angle-down" aria-hidden="true"></i></h6>
        ...
        <div class="headingWrap">
            <div class="innerWrap">
                <h6 class="js-collapsible" data-colapsible-target="#Heading_6">HEADING 6 <i class="fa fa-angle-down" aria-hidden="true"></i></h6>
                <div id="Heading_6" class="collapsible js-type-setting" data-selector="h4">
        ...
        <div class="headingWrap">
            <div class="innerWrap">
                <h6 class="js-collapsible" data-colapsible-target="#Paragraph">PARAGRAPH <i class="fa fa-angle-down" aria-hidden="true"></i></h6>
    ...
    <div class="js-resize resizer" id="resizer">
