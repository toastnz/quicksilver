...
<head>
    ...
    <link rel="stylesheet" href="$getThemeFolder/mysite/dist/styles/style.css"/>
    <!--[if (gte IE 6)&(lte IE 9)]>
	<script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/selectivizr/1.0.2/selectivizr-min.js"></script>
	<script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/modernizr/2.8.3/modernizr.min.js"></script>
	<link rel="stylesheet" href="$getThemeFolder/mysite/dist/styles/style.ie.css"/>
    <![endif]-->
...
<body class="$Classname <% if $VisibleCarouselItems %>has--slider<% end_if %><% if $URLSegment == 'Security' %> login-page<% end_if %>">
...
<div id="container">
	...
	<% if $Classname != 'HomePage' %>
        <div class="page-title page-title--pink">
...
<!--Javascript Includes-->
<script type="text/javascript" src="$getThemeFolder/mysite/dist/js/output.js"></script>
