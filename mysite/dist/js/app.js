...
$body.on('click', '.js-toggle-nav', function (e) {
    e.preventDefault();
    (0, _jquery2.default)(this).closest('.offCanvas__menu__item').toggleClass('open');
});

},{"./templates":2,"jquery":3}],2:[function(require,module,exports){
'use strict';
...
(0, _jquery2.default)('.js-modal').on('click', function (e) {
    e.preventDefault();
...
(0, _jquery2.default)('.js-youtube').on('click', function (e) {
    e.preventDefault();
    var modal = new _tingle2.default.modal({
        onClose: function onClose() {
            modal.destroy();
...
(0, _jquery2.default)('.js-confirm').on('click', function (e) {
    e.preventDefault();
    var modal = new _tingle2.default.modal({
        onClose: function onClose() {
            modal.destroy();
    ...
    modal.addFooterBtn('OKAY', 'button', function () {
        modal.close();
    });
    modal.open();
});

},{"jquery":3,"tingle.js":4}],3:[function(require,module,exports){
/*!
