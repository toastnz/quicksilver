...
var createBreakpoints = function createBreakpoints($sliderElement) {
  var inheritSlidesToScroll = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;
  ...
  var classBreakpoints = $sliderElement[0].className.split(' ');
  var slidesToScroll;
...
var makeSlider = function makeSlider(selector, options) {
  var inheritSlidesToScroll = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : true;
  var $el = jquery__WEBPACK_IMPORTED_MODULE_0___default()(selector);
  $el.each(function () {
    var $this = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this);
