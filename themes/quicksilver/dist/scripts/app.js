...
/* harmony import */ var _components_forms__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/forms */ "./themes/quicksilver/js/components/forms.js");
...
/* harmony import */ var _components_tabs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/tabs */ "./themes/quicksilver/js/components/tabs.js");
...
/* harmony import */ var _components_smoothScroll__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./components/smoothScroll */ "./themes/quicksilver/js/components/smoothScroll.js");
/*------------------------------------------------------------------
Stylesheets
------------------------------------------------------------------*/
...
selectAll('.js-tabs').forEach(function (group) {
  return new _components_tabs__WEBPACK_IMPORTED_MODULE_4__["default"](group);
}); // selectAll('.js-gallery').forEach((group) => new Gallery(group, sliders));

selectAll('[data-equalize]').forEach(function (group) {
  return new _components_equalizer__WEBPACK_IMPORTED_MODULE_6__["default"](group);
});
...
selectAll('[data-video]').forEach(function (el) {
  el.addEventListener('click', function (e) {
    e.preventDefault();
    el.insertAdjacentHTML('beforeend', new _components_videoEmbed__WEBPACK_IMPORTED_MODULE_7__["default"](el.dataset.video, {
      autoplay: 1
    }).render());
  });
});
new _components_smoothScroll__WEBPACK_IMPORTED_MODULE_8__["default"](document.querySelector('[data-smooth-scroll]'));
...
var lastInRow = __webpack_require__(/*! ../functions/lastInRow */ "./themes/quicksilver/js/functions/lastInRow.js"); // function lastInRow($element) {
...
function accordionAction($trigger, $target) {
  ...
  if ($trigger.hasClass('js-active')) {
    ...
    $allTriggers.removeClass('js-active');
    $allTargets.slideUp(); // $('.js-active').removeClass('js-active');
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()('.js-accordion').each(function () {
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()('.js-accordion-grid').each(function () {
  var $grid = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this);
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('body').on('click', '.js-accordion-grid--item', function (e) {
    e.preventDefault();
    $grid.css({
      height: 'auto'
    });
    ...
    if (!$this.hasClass('js-active')) {
      ...
      jquery__WEBPACK_IMPORTED_MODULE_0___default.a.ajax({
        ...
        success: function success(response) {
          var $template = jquery__WEBPACK_IMPORTED_MODULE_0___default()(response);
          $grid.find('.js-active').removeClass('js-active');
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('body').on('click', '.js-accordion-grid-close', function () {
    closeContent();
  });
...
/***/ "./themes/quicksilver/js/components/smoothScroll.js":
/*!**********************************************************!*\
  !*** ./themes/quicksilver/js/components/smoothScroll.js ***!
  \**********************************************************/
/*! exports provided: default */
...
function () {
  ...
  _createClass(SmoothScroll, [{
    ...
    value: function scroll() {
      if (!containsClass(document.body, 'touch')) this.content.style.transform = "translateY(-".concat(window.pageYOffset / this.height * 100, "%)");
    }
  }, {
    key: "update",
