...
buttons.forEach(function (button) {
  return button.addEventListener('click', function (e) {
    var modal = createModal(e.currentTarget);
...
var createModal = function createModal() {
  return new tingle_js__WEBPACK_IMPORTED_MODULE_0___default.a.modal({
...
var setContent = function setContent(modal, video_id, video_source) {
  return modal.setContent(videoModal(video_id, video_source));
};
