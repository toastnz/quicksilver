...
<div class="tingle-content-wrapper">
  ...
  #header h1 a {
    ...
    height: 80px;
            ...
            <h1 class="colour--blue">
                Level 1 heading class="colour--blue"
            </h1>
            <h1 class="colour--green">
                Level 1 heading class="colour--green"
            </h1>
            <h1 class="colour--red">
                Level 1 heading class="colour--red"
            </h1>
            <h1 class="colour--teal">
                Level 1 heading class="colour--teal"
            </h1>
            <h1 class="colour--yellow">
                Level 1 heading class="colour--yellow"
            </h1>
            <p>
                Sed scelerisque sagittis lorem. Phasellus sodales. Nulla urna justo, vehicula in, suscipit nec, molestie sed, tellus.
            </p>
