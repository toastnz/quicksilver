...
<html lang="en">
  ...
  <body class="$Classname" <% if $SiteConfig.GoogleMapsApiKey %>data-maps-api="$SiteConfig.GoogleMapsApiKey"<% end_if %> data-classname="$Classname" data-title="$Title" data-url-segment="$URLSegment" data-page-template="$Classname" data-equalize="header">
