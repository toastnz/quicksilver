        ...
        videoModal.setContent(`<div class="modal__close">
                               ...
                               <div class="modal wysiwyg">
                                 <div class="embed-container">
                                   <iframe width="560" height="315" src="https://www.youtube.com/embed/${$this.attr('data-video-id')}?controls=0&autoplay=1&rel=0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                 </div>
                               </div>`);
    }
    videoModal.open();
